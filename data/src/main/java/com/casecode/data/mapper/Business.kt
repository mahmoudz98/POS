...
{
   val businessData = this[BUSINESS_FIELD] as? Map<String,Any?> ?: emptyMap()
   ...
   val branchesData = businessData[BRANCHES_COLLECTION_PATH] as? List<Map<String, Any?>> ?: emptyList()
