...
class EmployeesBusinessRepositoryImplTest {
    ...
    @Test
    fun setEmployeesBusinessData_success() = testScope.runTest {
        // Arrange
        ...
        // Act
        val resultEmployees = employeesBusinessRepositoryImpl.setEmployees(employees, uid)
    ...
    @Test
    fun setEmployeesBusinessData_failure() = testScope.runTest {
        // Arrange
        val employees = createValidEmployees()
        // Mock firestore behavior
        every {
    ...
    @Test
    fun setEmployeesBusinessData_shouldReturnErrorUnKnowHostException() = testScope.runTest {
        // Arrange
        val employees = createValidEmployees()
        // Mock firestore behavior
        every {
