...
import com.casecode.pos.design.component.PosLoadingWheel
...
fun ItemsEmptyScreen(modifier: Modifier = Modifier) {
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.outline_inventory_2_120),
            contentDescription = stringResource(id = R.string.empty_items_icon),
            modifier = Modifier.size(120.dp),
        )

        Text(
            text = stringResource(id = R.string.empty_items_title),
        ...
        Text(
            text = stringResource(id = R.string.empty_items_message),
