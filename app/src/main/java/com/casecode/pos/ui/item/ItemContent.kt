...
import com.casecode.pos.design.component.scrollbar.DraggableScrollbar
import com.casecode.pos.design.component.scrollbar.rememberDraggableScroller
import com.casecode.pos.design.component.scrollbar.scrollbarState
import com.casecode.pos.design.icon.PosIcons
import com.casecode.pos.design.theme.POSTheme
import com.casecode.pos.design.ui.ItemsPreviewParameterProvider
    ...
    ListItem(
        ...
        supportingContent = {
            Row(modifier = Modifier.height(IntrinsicSize.Min)) {
                val formattedQuantity = "${stringResource(R.string.item_quantity_label)} $quantity"
                ...
                val formattedPrice =
                    DecimalFormat("#,###.##").format(price) + stringResource(R.string.item_currency_price)
                Text(formattedPrice)
            }
        },
        trailingContent = {
            IconButton(onClick = onPrintButtonClick) {
                Icon(
                    ...
                    contentDescription = stringResource(R.string.print_qr_code),
        ...
        modifier = modifier.combinedClickable(
            ...
            onLongClickLabel = stringResource(R.string.delete_item_title),
        ),
