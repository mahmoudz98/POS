...
class SignInOwnerUseCaseTest {
    ...
    @Test
    fun `invoke with perfect data should return Success`() = runTest {
        // Arrange
    ...
    @Test
    fun `invoke when google sign-in fails should return AuthenticationFailed`() = runTest {
        // Arrange
    ...
    @Test
    fun `invoke when user authenticates but has no business document should return AccountNeedsOnboarding`() =
        runTest {
            // Arrange
            testAuthRepository.sendSignInSuccess(testUser)
    ...
    @Test
    fun `invoke when business status is PENDING_ONBOARDING should return AccountNeedsOnboarding`() =
        runTest {
            // Arrange
            testAuthRepository.sendSignInSuccess(testUser)
    ...
    @Test
    fun `invoke when getting business fails with IOException should return NetworkError`() =
        runTest {
            // Arrange
            testAuthRepository.sendSignInSuccess(testUser)
    ...
    @Test
    fun `invoke when getting business fails with other Exception should return GeneralError`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `invoke when business is active but has no branches should return AccountNeedsOnboarding`() =
        runTest {
            // Arrange
            testAuthRepository.sendSignInSuccess(testUser)
            testBusinessRepository.addBusiness(testBusiness)
