 ...
 */
package com.casecode.pos.core.domain.usecase.old.employee

import com.casecode.pos.core.domain.usecase.old.AddEmployeesBusinessUseCase
...
class AddEmployeesBusinessUseCaseTest {
    ...
    @Test
    fun `when employees are not empty return Success`() = runTest {
        // Given
    ...
    @Test
    fun `when employees are empty return Empty`() = runTest {
        // Given
        val employees = arrayListOf<Employee>()
        // When
        val result = addEmployeesBusinessUseCase(employees)
    ...
    @Test
    fun `when employees are empty returns error`() = runTest {
        // Given
        val employees = arrayListOf<Employee>()
        // When
