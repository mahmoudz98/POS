 ...
 */
package com.casecode.pos.core.domain.usecase.old.supplier
...
class UpdateSupplierUseCaseTest {
    ...
    private val updateSupplierUseCase = UpdateSupplierUseCase(testSupplierRepository)
    private val oldSupplier = Supplier(
        id = "1",
        companyName = "Samsung",
        contactName = "John Doe",
        contactPhone = "12345678902131",
        contactEmail = "testold@supplier.com",
        address = "Test Address",
        category = "Electronics",
    )

    private val updateSupplier = Supplier(
        id = "1",
        companyName = "Samsung",
        contactName = "John Doe",
    ...
    @Test
    fun whenSupplierUpdated_returnSuccess() = runTest {
        val result = updateSupplierUseCase(oldSupplier, updateSupplier)
    ...
    fun whenHasError_returnsError() = runTest {
        ...
        val result = updateSupplierUseCase(oldSupplier, updateSupplier)
        assertEquals(
            OperationResult.Failure(stringData.core_data_update_supplier_failure_generic),
            result,
        )
    }
}