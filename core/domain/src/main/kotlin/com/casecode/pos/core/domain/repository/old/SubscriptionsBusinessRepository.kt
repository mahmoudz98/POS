 ...
 */
package com.casecode.pos.core.domain.repository.old

import com.casecode.pos.core.domain.utils.Resource
import com.casecode.pos.core.model.subscriptions.Subscription
import com.casecode.pos.core.model.users.SubscriptionBusiness
import kotlinx.coroutines.flow.Flow

typealias AddSubscriptionBusiness = Resource<Boolean>

interface SubscriptionsBusinessRepository {
    suspend fun setSubscriptionBusiness(subscriptionBusiness: Subscription): AddSubscriptionBusiness
