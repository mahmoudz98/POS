...
/**
 * A more specific validation exception for a business name that is too short or invalid.
 */
class InvalidBusinessNameException(message: String) : ValidationException(message)
