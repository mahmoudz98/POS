...
data class BillingEvent(
    ...
    companion object {
         ...
         */
        fun forPlanActivation(plan: SubscriptionPlan, currencyCode: String, paymentId: String? = null): BillingEvent {
            return BillingEvent(
                id = "", // Will be set by Firestore
                eventType = BillingEventType.CHARGE_SUCCESSFUL,
                description = "Activated plan: ${plan.name}",
                amount = BigDecimal.valueOf(plan.price),
