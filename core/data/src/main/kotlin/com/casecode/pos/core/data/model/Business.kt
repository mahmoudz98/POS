...
/**
 * Converts a [NetworkBusiness] data transfer object to a [Business] domain model.
 */
...
/**
 * Converts a [BusinessEntity] Room entity to a [NetworkBusiness] data transfer object.
 */
fun BusinessEntity.asNetworkModel(): NetworkBusiness = NetworkBusiness(
    id = this.businessId,
    name = this.name,
    ownerUid = this.ownerUid,
