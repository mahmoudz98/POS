        ...
        text = {
            Column {
                PosOutlinedTextField(
                    value = branchName,
                    onValueChange = { branchName = it ; nameError.value = it.isEmpty() },
                    isError = nameError.value,
                    label = stringResource(id = com.casecode.pos.core.ui.R.string.core_ui_branch_name_hint),
                    supportingText = if (nameError.value) stringResource(com.casecode.pos.core.ui.R.string.core_ui_error_branch_name_empty) else null,
                ...
                PosOutlinedTextField(
                    value = phoneNumber,
                    onValueChange = { phoneNumber = it ; phoneError.value = it.isEmpty() },
                    isError = phoneError.value,
                    supportingText = if (nameError.value) stringResource(com.casecode.pos.core.ui.R.string.core_ui_error_phone_empty) else null,
