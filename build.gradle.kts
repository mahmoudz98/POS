...
plugins {
   ...
   //  alias(libs.plugins.pos.android.application) apply false
   //alias(libs.plugins.pos.android.hilt) apply false
   //alias(libs.plugins.pos.android.library) apply false
   // alias(libs.plugins.pos.android.test) apply false
   //alias(libs.plugins.pos.android.firebase) apply false
